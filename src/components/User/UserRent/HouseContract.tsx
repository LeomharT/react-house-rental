...
class HouseContract extends Component<RouteComponentProps, {}>
{
    ...
    ExportPDF = async () =>
    {
        ...
        const canvas = await html2canvas(document.querySelector('.HouseContractMain') as HTMLDivElement);
        const jspdf = new jsPDF();
        jspdf.addImage(canvas.toDataURL(), 'JPEG', 25, 0, 150, 402);
        jspdf.addPage();
        jspdf.addImage(canvas.toDataURL(), 'JPEG', 25, -295, 150, 400);
    ...
    render()
    {
        ...
        return (
            <div className='HouseContract'>
                ...
                <main className='HouseContractMain'>
